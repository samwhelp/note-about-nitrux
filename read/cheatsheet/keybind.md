...
| 設定檔 |
| ----- |
| [~/.config/kglobalshortcutsrc](https://github.com/samwhelp/nitrux-adjustment/blob/main/prototype/main/nitrux-config/locale/en_us/Nitrux-Dark/asset/overlay/etc/skel/.config/kglobalshortcutsrc) |
...
| 按鍵組合     | 功能                                 | 設定項目                                                |
| ----------- | ----------------------------------- | ----------------------------------------------------- |
| `Alt + F1`  | `開啟「應用程式啟動主選單(Main Menu)」`  | `activate widget 116=`  |
| `Alt + F2`  | `開啟「應用程式啟動器(Runner)」`        | `krunner`  |


> 關於「`Alt + F1`」，

因為在「[~/.config/plasma-org.kde.plasma.desktop-appletsrc](https://github.com/samwhelp/nitrux-adjustment/blob/main/prototype/main/full-config/locale/en_us/Nitrux-Dark/asset/overlay/etc/skel/.config/plasma-org.kde.plasma.desktop-appletsrc#L221-L249)」，有一個「元件 (P-Connor.PlasmaDrawer)」。

``` ini

[Containments][4][Applets][116]
immutability=1
plugin=P-Connor.PlasmaDrawer


[Containments][4][Applets][116][Shortcuts]
global=Alt+F1

```

所以在「[~/.config/kglobalshortcutsrc](https://github.com/samwhelp/nitrux-adjustment/blob/main/prototype/main/nitrux-config/locale/en_us/Nitrux-Dark/asset/overlay/etc/skel/.config/kglobalshortcutsrc)」會被自動設定「`activate widget 116=Alt+F1,none,Activate Plasma Drawer Widget
`」。
...
| 按鍵組合   | 功能                  | 設定項目                            |
| ---------- | --------------------- | ----------------------------------- |
| `Win + grave`  | 切換到「所有工作空間概覽」  | `ShowDesktopGrid=`   |
...
| 相關連結 |
| ------- |
| [鍵盤按鍵綁定](https://samwhelp.github.io/note-about-nitrux/read/config/keybind.html) |
